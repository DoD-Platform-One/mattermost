...
![Version: 7.10.3-bb.1](https://img.shields.io/badge/Version-7.10.3--bb.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.10.3](https://img.shields.io/badge/AppVersion-7.10.3-informational?style=flat-square)
...
| database.readinessCheck.image | string | `"registry1.dso.mil/ironbank/opensource/postgres/postgresql12:12.15"` |  |
