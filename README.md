...
![Version: 9.4.2-bb.1](https://img.shields.io/badge/Version-9.4.2--bb.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.4.2](https://img.shields.io/badge/AppVersion-9.4.2-informational?style=flat-square)
...
| database.readinessCheck.image | string | `"registry1.dso.mil/ironbank/opensource/postgres/postgresql12:12.17"` |  |
